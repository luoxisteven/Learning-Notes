...
- In order to keep everything up to date, the newest version of the notes will be pulled from the link above at scheduled times every day and `continuously integrated and deployed (CI/CD)` through `crontab` into the backend of the website.
