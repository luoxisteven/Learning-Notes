...
- I take notes in an IDE like VS Code and then upload them to the GitHub repository above, and [**xiluo.net**](https://xiluo.net) fetches the latest notes from GitHub sources.
